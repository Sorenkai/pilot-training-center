<nav class="navbar navbar-expand bg-white topbar {{ (\Auth::user()->isInstructorOrAbove()) ? 'topbar-justify-moderator' : 'topbar-justify-user' }} mb-4 ps-4 pe-4 static-top shadow">
